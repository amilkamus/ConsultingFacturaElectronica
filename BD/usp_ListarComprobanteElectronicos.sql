if object_id('usp_ListarComprobanteElectronicos', 'p') is not null
	drop procedure usp_ListarComprobanteElectronicos
go
create procedure usp_ListarComprobanteElectronicos
(
	@estado int,
